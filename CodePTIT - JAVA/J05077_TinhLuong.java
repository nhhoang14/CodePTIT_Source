...
class NhanVien2 {
    ...
    public String toString() {
        return String.format("%s %s %s %d", this.id, this.name, this.pb, this.getTotal());
    }
}
...
public class J05077_TinhLuong {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < m; i++) {
            ...
            NhanVien2 x = new NhanVien2(id, name, ipd, day);
            x.setPB(dsPB.get(id.substring(3)));
            dsNV.add(x);
        }
        dsNV.forEach(e -> System.out.println(e));
    }
}